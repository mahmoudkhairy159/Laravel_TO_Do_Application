	...
	<div class="authentication-wrapper authentication-cover authentication-bg">
		<div class="authentication-inner row">
			...
			<div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-0">
              ...
              <span
	              class="app-brand-logo demo">@include('admin.layouts.macros',["height"=>20,"withbg"=>'fill: #fff;'])</span>
						</a>
					</div>
					<!-- /Logo -->
					...
					<form id="formAuthentication" class="mb-3" action="{{route('admin.check_login')}}" method="POST">
						@csrf
						<div class="mb-3">
							...
							<div class="mb-3" style=" position: relative;">
								<div style="position: absolute; top: 0; bottom: 0; left: 0; display: flex; align-items: center; pointer-events: none" class="text-bg-primary p-3 rounded-none">
			...
			<div class="d-none d-lg-flex col-lg-7 p-0">
				<div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
					<img src="{{ asset('assets/admin/img/illustrations/auth-login-illustration-'.$configData['style'].'.png') }}"
