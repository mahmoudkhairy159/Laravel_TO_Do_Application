  ...
  <div class="authentication-inner row justify-content-center">
    ...
    <div class="d-none d-lg-flex col-lg-6 p-0">
      <div class="auth-cover-bg auth-cover-bg-color d-flex justify-content-center align-items-center">
        <img src="{{ asset('assets/img/illustrations/1.png') }}" alt="auth-register-cover" class="img-fluid my-5" style="max-width: 100%;" data-app-light-img="illustrations/1.png" data-app-dark-img="illustrations/1.png">
      </div>
    </div>
    <!-- /Left Image -->
    ...
    <div class="d-flex col-12 col-lg-5 align-items-center p-sm-5 p-4">
      <div class="w-px-400 mx-auto">
        ...
        <h3 class="mb-1 fw-bold text-center">Adventure starts here 🚀</h3>
        <p class="mb-4 text-center">Make your app management easy and fun!</p>

        <form id="formAuthentication" class="mb-3" action="{{ route('user.check_register') }}" method="POST" enctype="multipart/form-data">
          @csrf
          <div class="mb-3">
