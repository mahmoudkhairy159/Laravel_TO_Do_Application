    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class="d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item">
                    <a href="{{ route('user.categories.index') }}">Category Management</a>
                </li>
...
<div class="card mb-4">
    ...
    <form class="card-body" action="{{ route('user.categories.update', $item->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="row mb-3">
            <label class="col-sm-3 col-form-label" for="task-name">Name <span class="text-danger">*</span></label>
            <div class="col-sm-9">
                <input type="text" value="{{ $item->name }}" name="name" id="task-name" class="form-control @error('name') is-invalid @enderror" placeholder="Enter Category Name" />
                @error('name')
        ...
        <div class="pt-4">
            <div class="row justify-content-start">
                <div class="col-sm-9">
                    <button type="submit" class="btn btn-primary me-sm-2 me-1">Update Category</button>
                </div>
            </div>
        </div>
    </form>
