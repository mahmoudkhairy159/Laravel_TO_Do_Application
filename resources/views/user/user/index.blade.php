    ...
    <div class="card">
        <div class="card-header">
            ...
            <div class="d-flex align-items-center justify-content-end ">
                <a href="{{ route('user.admin-management.create') }}"
                            ...
                            <tr>
                                ...
                                <td class="btn-group text-center">
                                    <div class="row  justify-content-center align-content-center  m-2">
                                        <div class="col-5">
                                            <a href="{{ route('user.admin-management.edit', $item->id) }}" class="btn"><i class="ti ti-edit ti-sm"></i></a>
                                        </div>
                                        <div class="col-5">
                                            <form action="{{ route('user.admin-management.destroy', $item->id) }}" method="post">
                                                @csrf
                                                @method('DELETE')
