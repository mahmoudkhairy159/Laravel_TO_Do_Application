    ...
    <div class="d-block mb-4 mb-md-0">
        <nav aria-label="breadcrumb" class=" d-md-inline-block">
            <ol class="breadcrumb breadcrumb-dark breadcrumb-transparent">
                ...
                <li class="breadcrumb-item ">
                    <a href="{{ route('user.admin-management.index') }}">Admin Mangement</a>
                </li>
...
<div class="card mb-4">
    ...
    <form class="card-body" action="{{ route('user.admin-management.update', $item->id)}}" method="post"
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input type="text" value="{{$item->name}}" name="name" id="multicol-full-name"
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <div class="input-group input-group-merge">
                    <input value="{{$item->email}}" type="text" name="email" id="multicol-email"
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input value="{{$item->phone}}" type="tel" name="phone" id="multicol-phone"
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input value="{{$item->job_title}}" type="text" name="job_title" id="job_title"
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <select required name="status" id="status" class="form-select @error('status') is-invalid @enderror">
                    <option value="{{ App\Models\User::STATUS_ACTIVE }}" {{ $item->status==App\Models\User::STATUS_ACTIVE ?'selected':''}}>Active</option>
                    <option value="{{ App\Models\User::STATUS_INACTIVE }}" {{ $item->status==App\Models\User::STATUS_INACTIVE ?'selected':''}}>InActive</option>
                </select>
                @error('status')
                <div class="text-danger">
                    <strong>{{ $message }}</strong>
        ...
        <div class="row mb-3">
            ...
            <div class="col-sm-9">
                <input {{$item->blocked ? "checked" :""}} type="checkbox" name="blocked" id="blocked"
