...
$(function () {
  ...
  if (dt_user_table.length) {
    var dt_user = dt_user_table.DataTable({
      ajax: "/getExpensesApi", // JSON file to add data
      columns: [
          ...
          render: function (data, type, full, meta) {
            let parent = `
              <div class="d-flex align-items-center">
                <a href="/expenses/edit/${full.id}" class="text-body"><i class="ti ti-edit ti-sm me-2"></i></a>
                <a onclick="return confirm('Are you sure?')" href="/expenses/delete/${full.id}" class="text-body "><i class="ti ti-trash ti-sm mx-2"></i></a>
