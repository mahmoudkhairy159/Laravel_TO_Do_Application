    ...
    return (function() {
        ...
        return (
            (function() {
                ...
                (S.THEMES = [
                    { name: 'theme-default', title: lang == 'en' ? "Default" : 'Default' },
                    { name: 'theme-semi-dark', title: lang == 'en' ? "Semi Dark" : 'Semi Dark' },
                    { name: 'theme-bordered', title: lang == 'en' ? " Borders" : 'Borders' }
                ]),
                (S.LANGUAGES = {
                    en: {
